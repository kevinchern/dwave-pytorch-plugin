...
from dwave.plugins.torch.models.losses.mmd import RBFKernel, mmd_loss
...
class TestDiscreteVariationalAutoencoder(unittest.TestCase):
    ...
    def test_train_encoder_with_mmd(self):
        ...
        kernel = RBFKernel(num_features=5, mul_factor=2.0, bandwidth=None)
